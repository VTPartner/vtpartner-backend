...
router.post("/all_goods_drivers", verifyToken, async (req, res) => {
  try {
    const query =
      "select goods_driver_id,driver_first_name,profile_pic,is_online,ratings,mobile_no,registration_date,goods_driverstbl.time,r_lat,r_lng,current_lat,current_lng,status,recent_online_pic,is_verified,goods_driverstbl.category_id,goods_driverstbl.vehicle_id,city_id,aadhar_no,pan_card_no,house_no,city_name,full_address,gender,owner_id,aadhar_card_front,aadhar_card_back,pan_card_front,pan_card_back,license_front,license_back,insurance_image,noc_image,pollution_certificate_image,rc_image,vehicle_image,vehicle_plate_image,category_name,vehicle_name,category_type from vtpartner.goods_driverstbl LEFT JOIN vtpartner.categorytbl ON goods_driverstbl.category_id = categorytbl.category_id LEFT JOIN vtpartner.vehiclestbl ON goods_driverstbl.vehicle_id = vehiclestbl.vehicle_id order by goods_driver_id desc";
    const values = [];
...
router.post("/all_cab_drivers", verifyToken, async (req, res) => {
  try {
    const query =
      "select cab_driver_id,driver_first_name,profile_pic,is_online,ratings,mobile_no,registration_date,cab_driverstbl.time,r_lat,r_lng,current_lat,current_lng,status,recent_online_pic,is_verified,cab_driverstbl.category_id,cab_driverstbl.vehicle_id,city_id,aadhar_no,pan_card_no,house_no,city_name,full_address,gender,owner_id,aadhar_card_front,aadhar_card_back,pan_card_front,pan_card_back,license_front,license_back,insurance_image,noc_image,pollution_certificate_image,rc_image,vehicle_image,vehicle_plate_image,category_name,vehicle_name,category_type from vtpartner.cab_driverstbl LEFT JOIN vtpartner.categorytbl ON cab_driverstbl.category_id = categorytbl.category_id LEFT JOIN vtpartner.vehiclestbl ON cab_driverstbl.vehicle_id = vehiclestbl.vehicle_id order by cab_driver_id desc";
    const values = [];
